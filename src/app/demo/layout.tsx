  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 flex flex-col">
      ...
      <div className="flex flex-1 mt-14">
        <Sidebar userInitials="JD" userFullName="Jane Doe" userEmail="demo@freelanceos.com" className="hidden md:flex" />
            ...
            <div className="flex items-center gap-2">
              <Sheet>
                ...
                <SheetContent side="left" className="p-0 bg-slate-950 border-slate-800 w-64 pt-10">
                  <Sidebar userInitials="JD" userFullName="Jane Doe" userEmail="demo@freelanceos.com" className="flex h-full border-none w-full" />
                </SheetContent>
              </Sheet>
              <span className="font-bold tracking-tight text-white">FreelanceOS</span>
            </div>
            <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-sm font-medium border border-slate-700">JD</div>
          </header>
